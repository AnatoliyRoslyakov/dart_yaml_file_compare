  ...
  Widget build(BuildContext context) {
    return DropTarget(
      onDragDone: (detail) async {
          list.addAll(detail.files); // <---отсюда релизовать ещё один эвент на обработку листа file
